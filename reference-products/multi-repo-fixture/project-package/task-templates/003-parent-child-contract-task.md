...
```sh
a2o kanban cli task-relation-create --project "A2OReferenceMultiRepo" --task "<parent-ref>" --other-task "<catalog-child-ref>" --relation-kind subtask
a2o kanban cli task-relation-create --project "A2OReferenceMultiRepo" --task "<parent-ref>" --other-task "<storefront-child-ref>" --relation-kind subtask
```
