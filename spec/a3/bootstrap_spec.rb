  ...
  describe ".runtime_package_session" do
    ...
    it "prefers the public A2O image version environment for runtime package descriptors" do
      Dir.mktmpdir do |dir|
        ...
        with_env("A2O_IMAGE_VERSION" => "0.5.12", "A3_IMAGE_VERSION" => "legacy") do
          ...
          expect(descriptor.image_version).to eq("0.5.12")
          expect(descriptor.operator_summary.fetch("distribution")).to include("image_ref=a3-engine:0.5.12")
        end
      end
    end
