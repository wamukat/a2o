...
RSpec.describe A3::Application::ShowBlockedDiagnosis do
  ...
  let(:doctor_result) do
    instance_double(
      ...
      runtime_validation_command_summary: "bin/a3 doctor-runtime /tmp/runtime/manifest.yml",
  ...
  it "enriches blocked diagnosis recovery with runtime package commands when provided" do
    ...
    doctor_result = instance_double(
      ...
      doctor_command_summary: "bin/a3 doctor-runtime /tmp/runtime/manifest.yml",
      runtime_command_summary: "bin/a3 execute-until-idle /tmp/runtime/manifest.yml",
      operator_guidance: "startup blocked by secret_delivery; provide secrets via environment variable A3_SECRET; run bin/a3 doctor-runtime /tmp/runtime/manifest.yml",
      next_command: "bin/a3 doctor-runtime /tmp/runtime/manifest.yml",
      migration_command_summary: "bin/a3 migrate-scheduler-store /tmp/runtime/manifest.yml",
      runtime_validation_command_summary: "bin/a3 doctor-runtime /tmp/runtime/manifest.yml",
      startup_sequence: "doctor=bin/a3 doctor-runtime /tmp/runtime/manifest.yml migrate=blocked runtime=blocked",
    ...
    expect(result.recovery).to have_attributes(
      runtime_package_guidance: "startup blocked by secret_delivery; provide secrets via environment variable A3_SECRET; run bin/a3 doctor-runtime /tmp/runtime/manifest.yml",
      ...
      runtime_package_runtime_validation_command: "bin/a3 doctor-runtime /tmp/runtime/manifest.yml",
