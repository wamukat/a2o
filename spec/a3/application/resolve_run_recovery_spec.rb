...
RSpec.describe A3::Application::ResolveRunRecovery do
  ...
  let(:doctor_result) do
    instance_double(
      ...
      execution_modes_summary: "one_shot_cli=bin/a3 doctor-runtime /tmp/manifest.yml ; scheduler_loop=bin/a3 execute-until-idle /tmp/manifest.yml ; doctor_inspect=bin/a3 doctor-runtime /tmp/manifest.yml",
      ...
      recommended_execution_mode_command: "bin/a3 doctor-runtime /tmp/manifest.yml",
