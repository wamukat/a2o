...
1. [docs/ja/90-user-quickstart.md](docs/ja/90-user-quickstart.md)
2. [docs/ja/60-container-distribution-and-project-runtime.md](docs/ja/60-container-distribution-and-project-runtime.md)
3. [docs/ja/68-reference-product-suite.md](docs/ja/68-reference-product-suite.md)
4. [docs/ja/00-design-map.md](docs/ja/00-design-map.md)
5. [docs/ja/70-implementation-status.md](docs/ja/70-implementation-status.md)
...
- 利用者マニュアル: [docs/ja/90-user-quickstart.md](docs/ja/90-user-quickstart.md)
...
各 product は `project-package/` を持ち、`a2o project bootstrap --package <package>` で runtime instance を作成できる。suite の目的、package contract、検証境界は [docs/ja/68-reference-product-suite.md](docs/ja/68-reference-product-suite.md) を参照する。
