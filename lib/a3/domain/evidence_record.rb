...
module A3
  module Domain
    class EvidenceRecord
      attr_reader :task_ref, :review_target, :source_descriptor, :scope_snapshot, :artifact_owner, :phase_records

      def self.build_initial(task_ref:, phase:, source_descriptor:, scope_snapshot:, review_target:, artifact_owner:)
        new(
          task_ref: task_ref,
      ...
      def initialize(task_ref:, review_target:, source_descriptor:, scope_snapshot:, artifact_owner:, phase_records:)
        @task_ref = task_ref
        @review_target = review_target
        @source_descriptor = source_descriptor
        @scope_snapshot = scope_snapshot
