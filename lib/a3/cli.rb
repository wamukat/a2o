...
require "a3/cli/artifact_handlers"
require "a3/cli/command_router"
require "a3/cli/decomposition_handlers"
require "a3/cli/handler_support"
require "a3/cli/host_package_handlers"
...
module A3
  module CLI
    ...
    extend ArtifactHandlers
    extend DecompositionHandlers
    extend HostPackageHandlers
    module_function
    ...
    def print_public_usage(out)
      ...
      out.puts("  docker run --rm -v \"$PWD/.work/a2o:/out\" ghcr.io/wamukat/a2o-engine:#{A3::VERSION} a2o host install --output-dir /out/bin --share-dir /out/share")
