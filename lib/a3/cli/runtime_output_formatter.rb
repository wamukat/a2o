  ...
  module CLI
    module RuntimeOutputFormatter
      ...
      def descriptor_runtime_summary_lines(descriptor)
        ...
        lines << "runtime_summary.agent_runtime_profile=#{descriptor.operator_summary.fetch('agent_runtime_profile')}"
        lines << "runtime_summary.agent_runtime_command=#{descriptor.operator_summary.fetch('agent_runtime_command')}"
        lines << "runtime_summary.agent_worker_gateway_options=#{descriptor.operator_summary.fetch('agent_worker_gateway_options')}"
      ...
      def runtime_summary_lines(operator_summary:, mount_summary:, repo_source_summary:, distribution_summary:, startup_readiness:, recommended_execution_mode:, recommended_execution_mode_reason:, recommended_execution_mode_command:, startup_blockers:, runtime_validation_command:, next_command:, startup_sequence:, contract_health:, operator_guidance:)
        ...
        lines << "runtime_summary.agent_runtime_profile=#{operator_summary.fetch('agent_runtime_profile', 'not_available')}"
        lines << "runtime_summary.agent_runtime_command=#{operator_summary.fetch('agent_runtime_command', 'not_available')}"
        lines << "runtime_summary.agent_worker_gateway_options=#{operator_summary.fetch('agent_worker_gateway_options', 'not_available')}"
