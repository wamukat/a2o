...
This prompt pack is a small baseline for A2O project packages that operate mainly in Japanese. Copy `prompts/` and `skills/` into a project package, then merge `project.yaml.snippet` into `runtime.prompts`.
