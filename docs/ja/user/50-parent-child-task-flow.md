...
読む目的は、複数リポジトリ作業を「1 つの巨大タスク」にせず、リポジトリ別の子タスクと統合用の親タスクへ分ける判断基準を理解することである。単一リポジトリで完結する場合はこの文書ではなく [20-project-package.md](20-project-package.md) と [30-operating-runtime.md](30-operating-runtime.md) を読む。
