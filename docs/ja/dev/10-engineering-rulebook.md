# A3 Engineering Rulebook

対象読者: A3 実装者 / reviewer
文書種別: 実装規律

この文書は、A3 実装時に常に守るべき開発ルールを固定する。
...
A3 は現行実装であり、旧 A3 / legacy automation 互換を最優先しない。
...
- 特定案件向け validation / migration / workspace rule を A3 の標準機能名として固定する
