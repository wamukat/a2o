...
- 未完了
  ...
  - root cleanup は current scheduler quarantine / results / logs の age+count+size retention と disposable cache の age+size retention まで拡張済みだが、scheduler-loop 自動削除と `.work` 全体棚卸しは未完
