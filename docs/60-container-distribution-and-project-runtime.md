...
- 未完了
  ...
  - root cleanup は current scheduler quarantine / results / logs の age+count retention と disposable cache の age retention まで拡張済みだが、size budget ベースの自動削除と `.work` 全体棚卸しは未完
