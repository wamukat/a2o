...
- `.work` inventory も current/disposable の一次分類まで完了し、`live-targets` は bootstrap source として keep、残る未完は `.work/a3/issues` と `.work/a3/notifications` の archive/delete judgment の最終化
