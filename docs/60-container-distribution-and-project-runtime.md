...
- 完了済み
  ...
  - SoloBoard local bundle は A3 runtime container と SoloBoard container を compose で起動し、runtime container 内から `watch-summary` / `show-state` / `execute-until-idle` を呼べるところまで確認済み
