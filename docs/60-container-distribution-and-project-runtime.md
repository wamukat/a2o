...
- TODO-4a: AI-assisted merge conflict recovery
  ...
  - implementation slices:
    ...
    - Slice 6: manual recovery reconcile command を追加し、operator が live repo に入れた commit を A3 internal state と SoloBoard に安全に対応づけられるようにする
    - Slice 7: Portal#245 型 fixture と parent-child / single の focused tests を追加し、サブエージェントレビューで設計思想と差分の両方を確認してから完了扱いにする
