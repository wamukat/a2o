...
- 未完了
  ...
  - terminal task の workspace / artifact / log cleanup は operator command と scheduler idle cleanup まで実装済み。残りは artifact store / logs / blocked diagnosis evidence の retention 仕様を長時間運用で検証すること
