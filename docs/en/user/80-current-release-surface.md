...
- Publish commit preflight configuration: `publish.commit_preflight.native_git_hooks` controls whether A2O-managed publish commits run native repository Git commit hooks. See [90-project-package-schema.md#publish](90-project-package-schema.md#publish).
