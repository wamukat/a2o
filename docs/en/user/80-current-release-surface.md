# A2O 0.5.18 Current Release Surface

This document describes the currently supported A2O 0.5.18 user surface and validation boundary.
...
- GHCR runtime image tags: `latest`, `0.5.18`, and `sha-*`
