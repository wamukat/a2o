# A2O 0.5.28 Current Release Surface

This document describes the currently supported A2O 0.5.28 user surface and validation boundary.
...
- Runtime diagnosis and recovery: `a2o runtime image-digest`, `doctor`, `watch-summary`, `logs <task-ref>`, `describe-task <task-ref>`, `skill-feedback list`, `skill-feedback propose`, `reset-task <task-ref>`, `show-artifact <artifact-id>`
...
- Kanbalone adapter and bootstrap tooling, defaulting to Kanbalone `v0.9.18`
...
- GHCR runtime image tags: `latest`, `0.5.28`, and `sha-*`
