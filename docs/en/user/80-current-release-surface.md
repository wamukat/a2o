...
- Runtime diagnosis and recovery: `a2o runtime image-digest`, `doctor`, `watch-summary`, `logs <task-ref>`, `describe-task <task-ref>`, `skill-feedback list`, `reset-task <task-ref>`, `show-artifact <artifact-id>`
