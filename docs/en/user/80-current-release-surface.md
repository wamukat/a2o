# A2O 0.5.16 Current Release Surface

This document describes the currently supported A2O 0.5.16 user surface and validation boundary.
...
- GHCR runtime image tags: `latest`, `0.5.16`, and `sha-*`
