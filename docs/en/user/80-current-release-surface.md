# A2O 0.5.37 Current Release Surface

This document describes the currently supported A2O 0.5.37 user surface and validation boundary.
...
- Kanbalone adapter and bootstrap tooling, defaulting to Kanbalone `v0.9.21`
...
- GHCR runtime image tags: `latest`, `0.5.37`, and `sha-*`
