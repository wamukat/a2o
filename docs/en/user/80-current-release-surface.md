# A2O 0.5.26 Current Release Surface

This document describes the currently supported A2O 0.5.26 user surface and validation boundary.
...
- GHCR runtime image tags: `latest`, `0.5.26`, and `sha-*`
