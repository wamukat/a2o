...
- [ ] SoloBoard bundled kanban and agent runtime packaging
  ...
  - Portal starters / UI app の単独 full verification は、それぞれ実 source repo で `a3-agent` 経由確認済み。repo:both / parent topology を含む full verification canary は次の project-specific integration slice として残る
