...
```sh
VERSION=0.5.0 ./scripts/build-release.sh
```
...
- archives, for example `dist/a3-agent-0.5.0-linux-amd64.tar.gz`
- `dist/checksums.txt`
...
```sh
./scripts/install-release.sh dist/a3-agent-0.5.0-linux-amd64.tar.gz
```
