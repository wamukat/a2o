...
The generated file uses the compact `runtime.executor.command` form. A2O expands it to the fixed stdin-bundle executor internally; full internal executor objects are not valid `project.yaml`.
