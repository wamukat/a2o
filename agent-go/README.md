...
```sh
VERSION=0.5.19 ./scripts/build-release.sh
```
...
- archives, for example `dist/a3-agent-0.5.19-linux-amd64.tar.gz`
- `dist/checksums.txt`
- `dist/release-manifest.jsonl`
- `dist/package-compatibility.json`
- `dist/a2o-agent-packages-0.5.19.tar.gz`
...
```sh
./scripts/install-release.sh dist/a3-agent-0.5.19-linux-amd64.tar.gz
```
