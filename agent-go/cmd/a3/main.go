...
func printUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  a2o runtime decomposition investigate|propose|review|create-children|status TASK_REF [--project-config project-test.yaml] [--repo-source SLOT=PATH]")
